...
Future<List<Map<String, dynamic>>> getDataChecklist(
    String competence, String level) async {
  try {
    ...
    print("------------------------------------------------");
    for (var teste in data.keys) {
      print("$teste--$competence");
    }
    print("A competência é $competence");
    print("Mapa de competências: ${data[competence]}");
    print(data[competence].runtimeType);
    ...
    List<Map<String, dynamic>> checklist =
        (data[competence] as List).whereType<Map<String, dynamic>>().toList();
