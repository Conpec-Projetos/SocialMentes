...
class SignUpDataPageState extends State<SignUpDataPage> {
  ...
  void nextData(bool paciente, bool profissional) {
    Navigator.push(
      ...
      CupertinoPageRoute(
          builder: (context) =>
              SignUpAddress(paciente: paciente, profissional: profissional)),
    );
  }
                  ...
                  return Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        left: widget.paciente
                            ? size.width * 80 / 390
                            : size.width * 107 / 390,
                        right: widget.paciente
                            ? size.width * 76 / 390
                            : size.width * 100 / 390,
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        child: _imageFile == null
                            ...
                            : Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      width: 2, color: const Color(0xFFD7D7D7)),
                          ...
                          child: Column(
                            ...
                            children: [
                              SignUpField(
                                ...
                                height: 50,
                                size: size,
                                text: widget.profissional
                                    ? 'Digite seu nome'
                                    : 'Digite o nome da criança',
                                identifierText: widget.profissional
                                    ? 'Nome completo'
                                    : 'Nome da criança',
                                identifierWidth:
                                    widget.profissional ? 140.33 : 152,
                                icon: true,
                                identifierIcon: widget.profissional
                                    ? Icons.person
                                    : Icons.child_care,
                                userType: widget.profissional
                                    ? 'Profissional'
                                    : 'Paciente',
                                index: 0,
                              ),
                              ...
                              SignUpField(
                                  controller: widget.profissional
                                      ? _emailController
                                      : _name2Controller,
                                  size: size,
                                  text: widget.profissional
                              ...
                              InkWell(
                                ...
                                onTap: (widget.paciente || widget.profissional)
                                    ? () => nextData(
                                        widget.paciente, widget.profissional)
                                    : () {},
                                child: ForwardButton(
                                  continuar: true,
                                  size: size,
